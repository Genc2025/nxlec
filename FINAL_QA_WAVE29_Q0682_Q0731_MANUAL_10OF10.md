# Manual Final QA Gate — Q0682–Q0731
...
- Maximum option max/min character ratio: **1.1481** (gate ≤ 1.15)
- Maximum correct-option deviation from distractor mean: **0.0866** (gate ≤ 0.10)
