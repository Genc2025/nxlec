...
import q1576_item,q1577_item,q1578_item,q1579_item,q1580_item

OUT=Path('usmle/batch_specs_1501_1600/16_q1576_q1580_author_20260913.json')
DB_BLOB='20a68f1500774333f082967440f383bcc5116c14'
TODAY='2026-09-13'
...
def main():
 items=[m.build(make) for m in (q1576_item,q1577_item,q1578_item,q1579_item,q1580_item)]
 b={'batch_id':'Q1576-Q1580-20260913','created_at':TODAY,'status':'AUTHOR_QA_PASS_PENDING_TECHNICAL_FREEZE_AND_INDEPENDENT_AUDIT','production_import_ready':False,'candidate_count':5,'canonical_count_before':1575,'canonical_count_after':1575,'canonical_db_blob':DB_BLOB,'answer_key_sequence':'ABCDE','answer_key_distribution':{L:1 for L in 'ABCDE'},'technical_integrity':{'source_hashes_fabricated':False,'source_hashes_complete':False,'independent_audit_complete':False,'trusted_importer_complete':False},'items':items}
 OUT.parent.mkdir(exist_ok=True); OUT.write_text(json.dumps(b,indent=2,ensure_ascii=False)+'\n')
 assert [x['num'] for x in items]==list(range(1576,1581))
