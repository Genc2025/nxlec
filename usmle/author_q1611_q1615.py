...
import q1611_item,q1612_item,q1613_item,q1614_item,q1615_item

OUT=Path('usmle/batch_specs_1601_1700/03_q1611_q1615_author_20260918.json')
DB_BLOB='e584d35979c100666a83ed10db98a6af6b57f36d'
TODAY='2026-09-18'
...
def main():
 items=[m.build(make_general) for m in (q1611_item,q1612_item,q1613_item,q1614_item,q1615_item)]
 b={
  'batch_id':'Q1611-Q1615-20260918',
  'created_at':TODAY,
  'status':'AUTHOR_QA_PASS_PENDING_TECHNICAL_FREEZE_AND_INDEPENDENT_AUDIT',
  'production_import_ready':False,
  'candidate_count':5,
  'canonical_count_before':1610,
  'canonical_count_after':1610,
  'canonical_db_blob':DB_BLOB,
  'answer_key_sequence':'ABCDE',
  'answer_key_distribution':{L:1 for L in 'ABCDE'},
  'construct_selection':'Prospective whole-bank screen against canonical Q0001-Q1610 plus manual semantic review and same-batch construct separation before authoring.',
  'technical_integrity':{
 ...
 assert [x['num'] for x in items]==list(range(1611,1616))
 ...
 print(json.dumps({'status':'AUTHOR_QA_PASS_PENDING_INDEPENDENT_AUDIT','items':5,'keys':'ABCDE','canonical_count':1610}))
