def build(make_general):
 return make_general(
  ...
  'Loss of which physiologic action most directly explains this finding?',
  {
   ...
   'C':'Neutralization of thrombin by antithrombin',
   'D':'Platelet adhesion mediated by von Willebrand factor binding to GPIb',
  ...
  [
   {
    'source_id':'Q1610-NCBI-GENE','title':'SERPINF2 serpin family F member 2 [Homo sapiens (human)] - Gene - NCBI',
