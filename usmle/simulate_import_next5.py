...
def main():
 ...
 with tempfile.TemporaryDirectory() as td:
  ...
  for n in range(START,END+1):
   d=copy.deepcopy(docs[n]); cid=f'S1-DIRECT-{n:04d}-20260910T210000Z'; d['candidate_id']=cid
   ...
   c.execute('insert into step2_final_items(candidate_id,payload_json,payload_sha256,audit_sha256,final_status,finalized_at) values(?,?,?,?,?,?)',(cid,canon(d),ph,rh,'FINAL_10_10_PASS','2026-09-10T21:00:00Z'))
   c.execute('insert into step2_final_reviews(candidate_id,review_json,review_sha256,final_status,finalized_at) values(?,?,?,?,?)',(cid,canon(review),rh,'FINAL_10_10_PASS','2026-09-10T21:00:00Z'))
