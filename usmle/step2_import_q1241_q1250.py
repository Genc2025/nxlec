...
STATE_PRE=ROOT/'state'/'step2_final_q0001_q1240.json'
STATE_POST=ROOT/'state'/'step2_final_q0001_q1250.json'
AUD=ROOT/'audit'
MANIFEST=AUD/'Q1241_Q1250_FINAL_QA_PASS.json'
FINAL_AUDIT=AUD/'STEP2_FINAL_10_10_Q0001_Q1250.json'
BATCH=ROOT/'batch_specs_1201_1300'/'07_q1241_q1250_author_20260906.json'
NEW_RANGE=range(1241,1251)
EXPECTED_KEYS={1241:'B',1242:'D',1243:'A',1244:'E',1245:'C',1246:'A',1247:'E',1248:'C',1249:'D',1250:'B'}
EXPECTED_PRE_COUNT=1240
EXPECTED_POST_COUNT=1250
EXPECTED_PRE_DB_BLOB='ec4393c3699a68616ea2877b464916b0db680328'
EXPECTED_BATCH_BLOB='74a9f64982189d58f0bff5e5204ff39cff931fdb'
EXPECTED_MANIFEST_BLOB='3cdb253ed2e825593c3aba5b44bec7ea940a6a35'
AUDIT_ID='STEP2-FINAL-Q0001-Q1250-20260906'
CID_SUFFIX='20260906T074000Z'
...
def load_candidates():
    ...
    if ''.join(docs[n]['item']['intended_key'] for n in NEW_RANGE)!='BDAECAECDB': raise SystemExit('candidate key sequence failure')
...
def main():
    ...
    if pre.get('final_status')!='FINAL_10_10_PASS' or int(pre.get('item_count',-1))!=EXPECTED_PRE_COUNT or pre.get('post_authoritative_db_blob')!=EXPECTED_PRE_DB_BLOB or pre.get('contiguous_q0001_q1240') is not True: raise SystemExit('pre-state Q1240 binding failure')
