...
TERMS=[
 ...
 'therapeutic misconception','emergency exception to informed consent','emancipated minor','mature minor doctrine','mandatory reporting child abuse',
 'duty to warn','Tarasoff','adolescent confidentiality','sexually transmitted infection confidentiality','qualified sign language interpreter',
 'auxiliary aids disability','ADA effective communication','professional boundaries','social media boundary','sexual boundary',
 'gifts from patients','impaired physician reporting','conscientious objection','medical futility','POLST','advance directive','ethics committee consultation',
