...
import q1586_item,q1587_item,q1588_item,q1589_item,q1590_item

OUT=Path('usmle/batch_specs_1501_1600/18_q1586_q1590_author_20260914.json')
DB_BLOB='979e1ca7fed788c323501f38a5afa441cf54f476'
TODAY='2026-09-14'
...
def main():
 items=[m.build(make) for m in (q1586_item,q1587_item,q1588_item,q1589_item,q1590_item)]
 b={'batch_id':'Q1586-Q1590-20260914','created_at':TODAY,'status':'AUTHOR_QA_PASS_PENDING_TECHNICAL_FREEZE_AND_INDEPENDENT_AUDIT','production_import_ready':False,'candidate_count':5,'canonical_count_before':1585,'canonical_count_after':1585,'canonical_db_blob':DB_BLOB,'answer_key_sequence':'ABCDE','answer_key_distribution':{L:1 for L in 'ABCDE'},'technical_integrity':{'source_hashes_fabricated':False,'source_hashes_complete':False,'independent_audit_complete':False,'trusted_importer_complete':False},'items':items}
 OUT.parent.mkdir(exist_ok=True); OUT.write_text(json.dumps(b,indent=2,ensure_ascii=False)+'\n')
 assert [x['num'] for x in items]==list(range(1586,1591))
