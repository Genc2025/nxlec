...
import q1591_item,q1592_item,q1593_item,q1594_item,q1595_item

OUT=Path('usmle/batch_specs_1501_1600/19_q1591_q1595_author_20260914.json')
DB_BLOB='3eb4c730ffc00197b307de201c94adea58831f14'
TODAY='2026-09-14'
...
def main():
 items=[m.build(make) for m in (q1591_item,q1592_item,q1593_item,q1594_item,q1595_item)]
 b={'batch_id':'Q1591-Q1595-20260914','created_at':TODAY,'status':'AUTHOR_QA_PASS_PENDING_TECHNICAL_FREEZE_AND_INDEPENDENT_AUDIT','production_import_ready':False,'candidate_count':5,'canonical_count_before':1590,'canonical_count_after':1590,'canonical_db_blob':DB_BLOB,'answer_key_sequence':'ABCDE','answer_key_distribution':{L:1 for L in 'ABCDE'},'technical_integrity':{'source_hashes_fabricated':False,'source_hashes_complete':False,'independent_audit_complete':False,'trusted_importer_complete':False},'items':items}
 OUT.parent.mkdir(exist_ok=True); OUT.write_text(json.dumps(b,indent=2,ensure_ascii=False)+'\n')
 assert [x['num'] for x in items]==list(range(1591,1596))
