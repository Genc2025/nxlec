...
def main():
    ...
    for idx,r0 in enumerate(rows):
        ...
        if sem:
            semantic_count+=1
            # Only explicitly listed fields may change semantically.
        ...
        # official metadata normalization; clinical meaning unchanged
        ...
        # Deterministic balanced answer-position normalization. Reorders text only.
        ...
        if sem is None:
            # no semantic content may change for mechanical-only records
    ...
    # exact duplicates after semantic corrections
